...
const NavBar = () => {
    ...
    const navLink = (
        <>
            ...
            <li>
                <NavLink className={({ isActive }) => (isActive ? 'font-bold ' : 'font-normal')} to="/allContest">
                    All Contest
                </NavLink>
            </li>
            <li>
            ...
            <div className="navbar">
                ...
                <div className="navbar-end">
                    <label className="swap swap-rotate md:mr-4">
                        ...
                        {/* sun icon */}
                        <svg className="swap-off text-stone-300 fill-current w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <div className="dropdown dropdown-end">
                                <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                                    <div className="w-10 rounded-full">
                                        <img alt="user pic" src={user?.photoURL || "https://i.ibb.co/p3d9pYn/user.png"} />
                                    </div>
                                </div>
                                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
